...
def get_fec(invoice):
  chat_response = client.chat.complete(
      model=model,
      messages=[{"role":"user", "content":"Crée et retourne uniquement le csv des écritures comptables en format FEC (fichiers des écritures comptables) pour la saisie comptable de cette facture: \n"+invoice}]
  )
