...
def get_fec(invoice):
  chat_response = client.chat.complete(
      model=model,
      messages=[{"role":"user", "content":"Génère un csv pour les écritures comptables en format FEC pour cette facture: \n"+invoice}]
  )
...
def process_files(uploaded_file):
    ...
    try:
        ...
        for page in pdf_document:
            ...
            textpage_ocr = page.get_textpage_ocr(flags=3, language='fr', dpi=72, full=False, tessdata=None)
